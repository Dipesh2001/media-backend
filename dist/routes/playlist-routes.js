...
router.get("/", playlist_controller_1.getAllPlaylists);
...
router.delete("/:id", auth_1.authAdmin, playlist_controller_1.deletePlaylist);
router.delete("/:id/status", auth_1.authAdmin, playlist_controller_1.deletePlaylist);
router.patch("/:id/status", auth_1.authAdmin, playlist_controller_1.togglePlayListStatus);
